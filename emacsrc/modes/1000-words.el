...
(defvar 2000-most-frequent-words
  '("the" "of" "and" "to" "a" "in" "that" "is" "was" "he" "for" "it"
    ...
    "determine" "cities" "element" "elements" "leaders" "division" "pretty"
    "existence" "attitude" "stress" "afternoon" "limited" "hardly"
    "thomas" "agreement" "factors" "scene" "easily" "closed" "write" "writes"
    ...
    "improved" "games" "cultural" "plenty" "mile" "components" "deterministic"
    "algorithm" "encrypted")
